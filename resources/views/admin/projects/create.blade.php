...
<div class="col-6 mx-auto">
    <form action="{{ route('project.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            {{-- utilizziamo la funzione old per ridare all'utente i valori inseriti prima,in caso di errore --}}
            <input type="text" class="form-control" name="slug" id="slug" aria-describedby="help" placeholder="Scrivi gli slug del tuo progetto" value="{{ old('slug', /* $project->authors */) }}">
